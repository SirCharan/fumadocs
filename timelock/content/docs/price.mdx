...
![Graph of the Dirac distribution δ(x)](/Pricing/Dirac_distribution.png)
...
![Approximation of the Dirac delta function using different zero-centered normal distributions](/Pricing/zero_centered.png)
...
![Example of Dirac delta function: Graph of the function δ_p(x) = p rect(px)](/Pricing/Dirac_delta.png)
...
![Graph illustrating the variations in theta across different days until expiration](/Pricing/theta.png)
